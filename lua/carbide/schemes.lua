...
local function fill_default_scheme(colors)
    ...
    return vim.tbl_extend(
...

        {
            ...
            ["@punctuation.special"] = { fg = colors.fgc_cyan_dim },

            ["@comment"] = { link = "Comment" },
            ["@comment.documentation"] = { fg = colors.fg2, bold = style.comments.bold, italic = false },
            ...
            ["@markup.link"] = { fg = colors.fgc_blue, underline = true },
        ...
        plugins["neo-tree.nvim"]
                and {
                    NeoTreeBufferNumber = { link = "Number" },
                    NeoTreeCursorLine = { link = "Cursorline" },
                    NeoTreeDimText = { link = "Conceal" },
                    NeoTreeDirectoryIcon = { fg = colors.fgc_blue_dim },
                    NeoTreeDirectoryName = { fg = colors.fgc_blue },
                    NeoTreeDotfile = { fg = colors.fg4 },
                    NeoTreeFileIcon = { fg = colors.fg3 },
                    NeoTreeFileName = { fg = colors.fg1 },
                    NeoTreeFileNameOpened = { link = "NeoTreeFileName" },
                    NeoTreeFilterTerm = { link = "Special" },
                    NeoTreeFloatBorder = { link = "FloatBorder" },
                    NeoTreeFloatTitle = { link = "FloatTitle" },
                    NeoTreeTitleBar = { link = "FloatTitle" },
                    NeoTreeGitAdded = { link = "Added" },
                    NeoTreeGitConflict = { fg = colors.fgc_yellow },
                    NeoTreeGitDeleted = { link = "Removed" },
                    NeoTreeGitIgnored = { fg = colors.fg3 },
                    NeoTreeGitModified = { link = "Changed" },
                    NeoTreeGitUnstaged = { fg = colors.fgc_green_dim },
                    NeoTreeGitUntracked = { fg = colors.fgc_yellow_dim },
                    NeoTreeGitStaged = { link = "Added" },
                    NeoTreeHiddenByName = { link = "NeoTreeDotfile" },
                    NeoTreeIndentMarker = { fg = colors.fg4 },
                    NeoTreeExpander = { fg = colors.fg3 },
                    NeoTreeNormal = { bg = colors.bg3 },
                    NeoTreeNormalNC = { link = "NeoTreeNormal" },
                    NeoTreeSignColumn = { link = "NeoTreeNormal" },
                    NeoTreeStats = { fg = colors.fg2 },
                    NeoTreeStatsHeader = { fg = colors.fg2, bold = true },
                    ...
                    NeoTreeRootName = { fg = colors.fg1, bold = true },
                    NeoTreeSymbolicLinkTarget = { fg = colors.fgc_cyan },
                    NeoTreeWindowsHidden = { link = "NeoTreeDotfile" },
                    NeoTreeModified = { link = "Special" },
                }
            or {},
