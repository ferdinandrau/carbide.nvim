...
local function fill_default_scheme(colors)
    ...
    return vim.tbl_extend(
...

        {
            ...
            SpecialChar = { fg = colors.fgc_cyan_bold, bold = style.strings.bold, italic = style.strings.italic },
            ...
            ["@markup.link.label"] = { fg = colors.fgc_cyan_bold },
        ...
        plugins["mini.icons"]
                and {
                    ...
                    MiniIconsOrange = { fg = colors.fgc_red_bold },
